...
// GÜVENLİK: CSRF koruması - "double submit cookie" deseni (goturyzhn ile aynı
// yaklaşım, bkz. goturyzhn/middlewares/csrf.js). Harici bağımlılık eklemeden:
...
function ensureCsrfToken(req, res, next) {
    ...
    // Not httpOnly: istemci tarafındaki script'ler bu cookie'yi okuyup her
    // fetch/AJAX isteğine header olarak ekliyor (bkz. public/js/csrf.js).
