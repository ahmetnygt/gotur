...
function initModels(sequelize) {
  ...
  // NOT: Aşağıdaki ilişkiler goturyzhn/utilities/initModels.js ile
  // tutarlı tutuluyor (aynı tenant veritabanı tabloları paylaşılıyor).
  // Önceden burada hiç ilişki tanımlı değildi; bu da `include` ile join
  // yapmayı imkânsız kılıyor ve iki proje arasında modelleme tutarsızlığı
  // oluşturuyordu.
